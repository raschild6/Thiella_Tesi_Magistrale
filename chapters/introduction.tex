...
\begin{itemize}
	...
	\item Not only maintain, but rather exploit existing Narrow-AI systems as modules of the AGI system, in order to take advantage of their potential and allow interaction between them in a "single" large knowledge base.
\end{itemize}

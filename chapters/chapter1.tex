...
%%To greatly simplify the work in this project, certain logic was used, so all TruthValues associated with atoms are always true, but, as amply demonstrated above, the system is set up to work in completely uncertain environments and with uncertain reasoning. \cite{goertzel2008probabilistic}
